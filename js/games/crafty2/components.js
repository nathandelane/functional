...
Crafty.c("Camera", {
    ...
    camera: function(player) {
        ...
        player.bind("Moved", function(location) { that.set(location); });
    },
    set: function(obj) {
        Crafty.viewport.x = -player.at().x + Crafty.viewport.width / 2;
        Crafty.viewport.y = -player.at().y + Crafty.viewport.height / 2;
    }
});